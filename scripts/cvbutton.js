...
btn6.addEventListener("click", () => {
  ...
  downloadLink.href = "CV/CV_maheshi anuradha.pdf";
  downloadLink.download = "CV-Maheshi Anuradha.pdf";
...
document.getElementById("ecobtn").addEventListener("click", () => {
  ...
  // Set the file URL and name
  downloadLink.href = "case/Ecopilot.pdf";
  downloadLink.download = "Ecopilot.pdf";
...
document.getElementById("codobtn").addEventListener("click", () => {
  // Create a new anchor element to download the file
  const downloadLink = document.createElement("a");

  // Set the file URL and name
  downloadLink.href = "case/Coderdojo.pdf";
  downloadLink.download = "CoderDojo.pdf";
